...
__help__ = """
Chatbot utilizes the CoffeeHouse API and allows CIA to talk back making your chat more interactive.
This is an ongoing upgrade and is only available for some Developers. 

In future we might make it open for any chat and controllable by group admins.

Powered by CoffeeHouse (https://coffeehouse.intellivoid.net/) from @Intellivoid
Commands: These only work for CIA Staff users. 
